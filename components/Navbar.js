    ...
    return (
        ...
        <div className='bg-white h-22.5 w-[90%] rounded-[50px] fixed left-[50%] translate-x-[-50%] top-12 flex pl-11.25 items-center gap-12 justify-between z-10'>
            ...
            <div className="login-signup flex items-center pr-3.5 gap-2">
                <button className='h-15.5 rounded-xl text-black bg-[#e9e9e9a5]  whitespace-nowrap p-6 flex justify-center items-center font-semibold text-lg hover:bg-[#E9E9E9] cursor-pointer'>Log in</button>
                <button className='h-15.5 rounded-4xl text-white bg-[#1E2330] whitespace-nowrap p-6 flex justify-center items-center font-semibold text-lg cursor-pointer'>Sign up free</button>
            </div>
